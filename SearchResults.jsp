...
<body>
    ...
    <div class="display-setting container align-items-center p-2">
        <div class="row ">
            <div class="col-1.5 ">
                <div class="dropdown">
                    <button class="btn btn-sm dropdown-toggle" style="background-color:rgba(152, 114, 132, 0.4); color:#4B4237" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Sort by popularity
                    </button>
                    ...
                    <div class="row no-gutters position-relative">
                        ...
                        <div class="col-md-8 mt-3 position-static">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-muted">Organized by Xiao Ming</small></p>
                            </div>
        ...
        <div class="modal-dialog" role="document">
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn" style="color:#F9F1F0; background-color:rgba(152, 114, 132, 0.4); color: grey" data-dismiss="modal">Close</button>
                    <button type="button" class="btn" style="color:#F9F1F0; background-color:#EE7674">Send message</button>
                </div>
            </div>
        </div>
    </div>
	...
	<script>
			...
			for (i = 0; i < 3; i++) {
				$("#results").append( '<div class="row"><div class="card shadow-lg mb-3" style="max-width: 70%;">'
						+ '<div class="col-md-4 p-4 ">' + '<img src="img\lightbulb.png" class="card-img" alt=""/>'
